          ...
          {offerings.map((item, i) => (
            ...
            >
              <div className="flex justify-between items-start mb-8">
                <div
                  className={`w-14 h-14 rounded-2xl bg-gradient-to-br ${item.color} text-white flex items-center justify-center text-2xl shadow-lg shadow-indigo-100 group-hover:scale-110 transition-transform`}
                >
                  {item.icon}
                </div>
                <span className="px-3 py-1 rounded-full bg-slate-100 text-slate-500 text-[9px] font-black tracking-widest uppercase">
                  {item.tag}
                </span>
              </div>
